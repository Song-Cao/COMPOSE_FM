...
% single-brace syntax: writing a {{...}} artifact marker directly inside
% \includegraphics{...} produces {{{...}}}, which graphicx cannot parse. Building inside
% the repo, the relative path is what you want; the commented alternative resolves to the
% stored artifact when the file is read outside the repo.
\newcommand{\figcases}{figures/fig2_case_studies.png}
% \renewcommand{\figcases}{{artifact:art_e4061ed5-fad8-4faf-9652-a2dba830d479}}
